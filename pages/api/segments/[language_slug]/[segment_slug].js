import { getAllSentences } from "../../../../src/backend/getAllSentences"
...
export default async function handler(req, res) {
  ...
  // TODO: Check for phone number instead of this field
  // TODO: Also remove contributor field after
  ...
  switch (req.method) {
    case 'GET': return getAllSentences(req, res)
