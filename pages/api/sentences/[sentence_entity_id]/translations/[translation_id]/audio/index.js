import { createAudio } from "../../../../../../../src/backend/createAudio"
import { getAudio } from "../../../../../../../src/backend/getAudio"
...
export default async function handler(req, res) {
  ...
  switch (req.method) {
    case 'POST': return createAudio(req, res, auth.user.id)
    case 'GET': return getAudio(req, res, auth.user.id)
